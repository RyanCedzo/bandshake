				...
				<div
					...
					<div className="flex pt-8 gap-4">
						...
						<a
							...
							rel="noopener noreferrer"
						>
							<svg fill="#1C2033" width="52" height="52" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
							<path d="M549.655 124.083c-6.281-23.65-24.786-42.161-48.435-48.441C456.514 64 288 64 288 64s-168.514 0-213.22 11.642c-23.65 6.281-42.154 24.792-48.435 48.441C16 168.712 16 256 16 256s0 87.288 10.345 131.917c6.281 23.649 24.786 42.16 48.435 48.441C119.486 448 288 448 288 448s168.514 0 213.22-11.642c23.649-6.281 42.154-24.792 48.435-48.441C560 343.288 560 256 560 256s0-87.288-10.345-131.917zM232 336V176l142 80-142 80z"/>
							</svg>
						</a>
						...
						<a
							...
							rel="noopener noreferrer"
						>
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="52" height="52" fill="#1C2033">
								<path d="M128 0c70.7 0 128 57.3 128 128 0 70.7-57.3 128-128 128C57.3 256 0 198.7 0 128 0 57.3 57.3 0 128 0zm24.7 87.6c-6.5 0-12.3-2.6-16.7-6.8v64.2c0 14.9-12.1 27-27 27s-27-12.1-27-27c0-12.7 9-23.3 20.8-26.3V77.3c-15.7 3.3-28.1 17.6-28.1 34.3 0 19 15.4 34.4 34.4 34.4s34.4-15.4 34.4-34.4V77.3c4.4 4.3 10.2 6.8 16.7 6.8 11.8 0 21.3-9.5 21.3-21.3s-9.5-21.3-21.3-21.3z"/>
							</svg>
						</a>
					</div>
				</div>
